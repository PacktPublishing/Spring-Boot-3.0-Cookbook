...
public class FootballServiceTest {
    ...
    public void getMatchEventsOfType() {
        List<MatchEvent> events = footballService.getMatchEventsOfType(400222852, 24);
        assertThat(events, not(empty()));
    }

    @Test
    public void getMatchEventsOfType_notFound() {
        List<MatchEvent> events = footballService.getMatchEventsOfType(9999999, 24);
        assertThat(events, empty());
    }

    @Test
    public void getMatchWithPlayerEvents() {
        List<MatchEvent> events = footballService.getMatchWithPlayerEvents(400222852, 358189);
        assertThat(events, not(empty()));
    }

    @Test
    public void getMatchWithPlayerEvents_notFound() {
        List<MatchEvent> events = footballService.getMatchWithPlayerEvents(9999999, 358189);
        assertThat(events, empty());
    }
    ...
    public void getMatchWithPlayerEventsError() {
        assertThrows(InvalidDataAccessResourceUsageException.class,
                () -> footballService.getMatchWithPlayerEventsError(400222852, 358189));
    }
