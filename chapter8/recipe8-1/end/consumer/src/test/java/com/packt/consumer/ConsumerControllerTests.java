...
public class ConsumerControllerTests {
    ...
    public void getCards() {
        ...
        // ACT & ASSERT
        webTestClient.get().uri("/consumer/cards").exchange()
                .expectStatus().isOk()
    ...
    public void getCard_found() {
        // ARRANGE
        server.stubFor(WireMock.get(WireMock.urlEqualTo("/cards/1"))
                .willReturn(WireMock.aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
                        .withBody("""
        ...
        // ACT & ASSERT
        webTestClient.get().uri("/consumer/cards/1").exchange()
                .expectStatus().isOk()
    ...
    public void getFailedRequest_remoteError() {
        // ARRANGE
        server.stubFor(WireMock.get(WireMock.urlEqualTo("/invalidpath"))
                .willReturn(WireMock.aResponse()
                        .withStatus(500)
                        .withHeader("Content-Type", "application/json")
                        .withBody("""
        ...
        // ACT & ASSERT
        String content = webTestClient.get().uri("/consumer/error").exchange()
                .expectStatus().isOk()
    ...
    public void getFailedRequest_remoteNotFound() {
        ...
        // ACT & ASSERT
        webTestClient.get().uri("/consumer/error").exchange()
                .expectStatus().isOk()
