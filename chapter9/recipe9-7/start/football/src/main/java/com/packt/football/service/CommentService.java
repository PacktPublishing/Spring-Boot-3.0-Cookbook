...
import com.packt.football.repo.CommentRepository;
...
public class CommentService {
    ...
    public Comment postComment(CommentPost commentPost) {
        ...
        comment.setUserId(commentPost.getUserId());
        comment.setTargetType(commentPost.getTargetType());
        comment.setTargetId(commentPost.getTargetId());
        comment.setContent(commentPost.getCommentContent());
        comment.setDate(LocalDateTime.now());
        comment.setLabels(commentPost.getLabels());
